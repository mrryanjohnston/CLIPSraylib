...
(deffacts textures
	(texture (name background) (texture (raylib-load-texture "./examples/cyberpunk_street_background.png")) (delta 0.1))
	(texture (name foreground) (texture (raylib-load-texture "./examples/cyberpunk_street_foreground.png")) (delta 1.0))
	(texture (name midground) (texture (raylib-load-texture "./examples/cyberpunk_street_midground.png")) (delta 0.5)))
...
(defrule draw
	...
	(raylib-begin-drawing)
		(raylib-clear-background (raylib-get-color (raylib-hex-string-to-int "0x052c46ff")))
