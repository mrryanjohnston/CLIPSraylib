...
void OpenFunction(
  ...
  UDFValue *returnValue)
  {
   ...
   if ((fileName = _GetFileName(context)) == NULL)
     {
      returnValue->lexemeValue = FalseSymbol(theEnv);
      return;
     }
...
void RemoveFunction(
  ...
  UDFValue *returnValue)
  {
   ...
   if ((theFileName = _GetFileName(context)) == NULL)
     {
      returnValue->lexemeValue = FalseSymbol(theEnv);
      return;
     }
...
void RenameFunction(
  ...
  UDFValue *returnValue)
  {
   ...
   if ((oldFileName = _GetFileName(context)) == NULL)
     {
      returnValue->lexemeValue = FalseSymbol(theEnv);
      return;
     }

   if ((newFileName = _GetFileName(context)) == NULL)
     {
      returnValue->lexemeValue = FalseSymbol(theEnv);
      return;
     }
